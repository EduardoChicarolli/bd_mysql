...
-- -----------------------------------------------------
-- Table `blog_pessoal`.`tb_tabelas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `blog_pessoal`.`tb_tabelas` (
...
CREATE TABLE IF NOT EXISTS `blog_pessoal`.`tb_postagens` (
  ...
  `data` DATE NULL,
  `tb_tabelas_id` BIGINT NOT NULL,
  `tb_usuarios_id` BIGINT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_tb_postagens_tb_tabelas_idx` (`tb_tabelas_id` ASC) VISIBLE,
  INDEX `fk_tb_postagens_tb_usuarios1_idx` (`tb_usuarios_id` ASC) VISIBLE,
  CONSTRAINT `fk_tb_postagens_tb_tabelas`
    FOREIGN KEY (`tb_tabelas_id`)
    REFERENCES `blog_pessoal`.`tb_tabelas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
